...
class _FakePlutoGridLocaleText_0 extends _i1.SmartFake
    implements _i2.PlutoGridLocaleText {
  _FakePlutoGridLocaleText_0(
    Object parent,
...
class _FakePlutoGridKeyPressed_1 extends _i1.SmartFake
    implements _i2.PlutoGridKeyPressed {
  _FakePlutoGridKeyPressed_1(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakePlutoGridCellPosition_2 extends _i1.SmartFake
    implements _i2.PlutoGridCellPosition {
  _FakePlutoGridCellPosition_2(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class _FakePlutoRow_3 extends _i1.SmartFake implements _i2.PlutoRow {
  _FakePlutoRow_3(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class MockPlutoGridStateManager extends _i1.Mock
  ...
  _i2.PlutoGridLocaleText get localeText => (super.noSuchMethod(
        ...
        returnValue: _FakePlutoGridLocaleText_0(
          this,
          Invocation.getter(#localeText),
        ),
  ...
  _i2.PlutoGridKeyPressed get keyPressed => (super.noSuchMethod(
        ...
        returnValue: _FakePlutoGridKeyPressed_1(
          this,
          Invocation.getter(#keyPressed),
        ),
  ...
  @override
  double get offsetHeight => (super.noSuchMethod(
  ...
  @override
  set refRows(_i2.FilteredList<_i2.PlutoRow?>? setRows) => super.noSuchMethod(
        Invocation.setter(
          #refRows,
          setRows,
        ),
  ...
  @override
  bool isShowFrozenColumn(double? maxWidth) => (super.noSuchMethod(
        Invocation.method(
          #isShowFrozenColumn,
          [maxWidth],
        ),
  ...
  @override
  void toggleSortColumn(_i6.Key? columnKey) => super.noSuchMethod(
        Invocation.method(
          #toggleSortColumn,
          [columnKey],
        ),
  ...
  @override
  void sortAscending(_i2.PlutoColumn? column) => super.noSuchMethod(
        Invocation.method(
          #sortAscending,
          [column],
        ),
  ...
  @override
  void sortDescending(_i2.PlutoColumn? column) => super.noSuchMethod(
        Invocation.method(
          #sortDescending,
          [column],
        ),
  ...
  @override
  void sortBySortIdx() => super.noSuchMethod(
        Invocation.method(
          #sortBySortIdx,
          [],
        ),
  ...
  @override
  void showSetColumnsPopup(_i6.BuildContext? context) => super.noSuchMethod(
        Invocation.method(
          #showSetColumnsPopup,
          [context],
        ),
  ...
  @override
  bool isRowBeingDragged(_i6.Key? rowKey) => (super.noSuchMethod(
        Invocation.method(
          #isRowBeingDragged,
          [rowKey],
        ),
  ...
  @override
  void setGridFocusNode(_i6.FocusNode? focusNode) => super.noSuchMethod(
        Invocation.method(
          #setGridFocusNode,
          [focusNode],
        ),
  ...
  @override
  void setKeyPressed(_i2.PlutoGridKeyPressed? keyPressed) => super.noSuchMethod(
        Invocation.method(
          #setKeyPressed,
          [keyPressed],
        ),
  ...
  @override
  void resetKeyPressed() => super.noSuchMethod(
        Invocation.method(
          #resetKeyPressed,
          [],
        ),
  ...
  @override
  void setLayout(_i6.BoxConstraints? size) => super.noSuchMethod(
        Invocation.method(
          #setLayout,
          [size],
        ),
  ...
  @override
  void setShowLoading(bool? flag) => super.noSuchMethod(
        Invocation.method(
          #setShowLoading,
          [flag],
        ),
  ...
  @override
  void resetPage({bool? notify = true}) => super.noSuchMethod(
        Invocation.method(
          #resetPage,
          [],
          {#notify: notify},
  ...
  @override
  List<_i2.PlutoRow> setSortIdxOfRows(
    List<_i2.PlutoRow>? rows, {
    bool? increase = true,
    int? start = 0,
  }) =>
  ...
  @override
  void setScroll(_i2.PlutoGridScrollController? scroll) => super.noSuchMethod(
        Invocation.method(
          #setScroll,
          [scroll],
        ),
  ...
  @override
  void setSelecting(bool? flag) => super.noSuchMethod(
        Invocation.method(
          #setSelecting,
          [flag],
        ),
  ...
  @override
  void setSelectingMode(_i2.PlutoGridSelectingMode? mode) => super.noSuchMethod(
        Invocation.method(
          #setSelectingMode,
          [mode],
        ),
  ...
  @override
  bool isSelectedRow(_i6.Key? rowKey) => (super.noSuchMethod(
        Invocation.method(
          #isSelectedRow,
          [rowKey],
        ),
...
class MockPlutoGridEventManager extends _i1.Mock
  ...
  @override
  _i3.PublishSubject<_i2.PlutoGridEvent> get subject => (super.noSuchMethod(
